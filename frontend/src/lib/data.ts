...
const ALL_DIRECTIONS = ["Cabinet", "Direction des Services Techniques", "Direction des Affaires Sociales", "Direction des Services Financiers"];
function rights(arr: string[]): Record<string, boolean> {
  const o: Record<string, boolean> = {};
  ALL_DIRECTIONS.forEach(t => o[t] = arr.includes(t));
  return o;
}

export const USERS: User[] = [
  { id: "u1", nom: "DONOU", prenom: "Archille", name: "Archille DONOU", telephone: "01 23 45 67 01", adresse: "Dangbo centre", service: "Secrétariat Général", direction: "Cabinet", statut_matrimoniale: "Marié(e)", carte: "C-000001", initials: "AD", role: "admin", color: "#0c6e4a", status: "actif",   last: "il y a 4 min",   rights: rights(ALL_DIRECTIONS) },
  { id: "u2", nom: "GONZALLO", prenom: "Raissa", name: "Raissa GONZALLO", telephone: "01 23 45 67 02", adresse: "Dangbo centre", service: "Secrétariat Général", direction: "Cabinet", statut_matrimoniale: "Marié(e)", carte: "C-000002", initials: "RG", role: "chef", color: "#0c6e4a", status: "actif",   last: "il y a 5 min",  rights: rights(ALL_DIRECTIONS) },
  { id: "u3", nom: "Boko", prenom: "Louis", name: "Louis Boko", telephone: "01 23 45 67 03", adresse: "Kessounou", service: "Urbanisme & Foncier", direction: "Direction des Services Techniques", statut_matrimoniale: "Marié(e)", carte: "C-000003", initials: "LB", role: "consultant", color: "#6a4d8c", status: "actif",   last: "il y a 1 h",     rights: rights(["Direction des Services Techniques"]) },
  { id: "u4", nom: "KPONOU", prenom: "Chancelle", name: "Chancelle KPONOU", telephone: "01 23 45 67 04", adresse: "Dangbo", service: "État Civil", direction: "Direction des Services Techniques", statut_matrimoniale: "Célibataire", carte: "C-000004", initials: "CK", role: "saisisseur", color: "#3c5d76", status: "actif",   last: "il y a 1 h",     rights: rights(["Direction des Services Techniques"]) },
  { id: "u5", nom: "Zinsou", prenom: "Bénédicta", name: "Bénédicta Zinsou", telephone: "01 23 45 67 05", adresse: "Dèkin", service: "Affaires Sociales", direction: "Direction des Affaires Sociales", statut_matrimoniale: "Divorcé(e)", carte: "C-000005", initials: "BZ", role: "consultant", color: "#b0563f", status: "actif",   last: "hier",            rights: rights(["Direction des Affaires Sociales"]) },
  { id: "u6", nom: "Adjovi", prenom: "Gérard", name: "Gérard Adjovi", telephone: "01 23 45 67 06", adresse: "Zounguè", service: "Services Financiers", direction: "Direction des Services Financiers", statut_matrimoniale: "Marié(e)", carte: "C-000006", initials: "GA", role: "saisisseur", color: "#2f7d6b", status: "inactif", last: "il y a 9 j",     rights: rights(["Direction des Services Financiers"]) },
  { id: "u7", nom: "Sodjinou", prenom: "Florine", name: "Florine Sodjinou", telephone: "01 23 45 67 07", adresse: "Dangbo centre", service: "État Civil", direction: "Direction des Services Techniques", statut_matrimoniale: "Célibataire", carte: "C-000007", initials: "FS", role: "consultant", color: "#8c5a3c", status: "actif",   last: "il y a 35 min",  rights: rights(["Direction des Services Techniques"]) },
  { id: "u8", nom: "Dossou", prenom: "Innocent", name: "Innocent Dossou", telephone: "01 23 45 67 08", adresse: "Gbéko", service: "Affaires Domaniales", direction: "Cabinet", statut_matrimoniale: "Marié(e)", carte: "C-000008", initials: "ID", role: "chef",       color: "#456a8a", status: "actif",   last: "il y a 3 h",     rights: rights(ALL_DIRECTIONS) },
];
...
export const DOCS: Doc[] = [
  { id: "d1",  cote: "", title: "Registre des naissances — Arrondissement de Hozin",
  ...
  { id: "d2",  cote: "", title: "Permis de construire — Lot 38, Dèkin-Hounhouè",
  ...
  { id: "d3",  cote: "", title: "Courrier arrivé — Préfecture de l'Ouémé / Subvention FADeC",
  ...
  { id: "d4",  cote: "", title: "Registre des mariages — Dangbo Centre (1998)",
  ...
  { id: "d5",  cote: "", title: "Délibération budgétaire — Exercice 2025 (Projet)",
  ...
  { id: "d6",  cote: "", title: "Plan de lotissement — Zone Gbéko Nord",
  ...
  { id: "d7",  cote: "", title: "Registre des décès — Arrondissement de Kessounou",
  ...
  { id: "d8",  cote: "", title: "Courrier départ — Demande d'appui ANCB",
  ...
  { id: "d9",  cote: "", title: "Mandat de paiement — Travaux voirie Zounguè",
  ...
  { id: "d10", cote: "", title: "Certificat d'urbanisme — Parcelle 112, Hêtin-Houédomey",
  ...
  { id: "d11", cote: "", title: "Registre des naissances — Dangbo Centre (2002)",
  ...
  { id: "d12", cote: "", title: "Courrier arrivé — Ministère de la Décentralisation",
  ...
  { id: "d13", cote: "", title: "Titre de recette — Taxe de marché Dangbo",
  ...
  { id: "d14", cote: "", title: "Plan de lotissement — Extension Dangbo Sud",
  ...
  { id: "d15", cote: "", title: "Registre des mariages — Arrondissement de Dèkin",
  ...
  { id: "d16", cote: "", title: "Courrier départ — Convocation conseil communal",
